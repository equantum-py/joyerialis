...
const DESKTOP_LOGO_SRC = 'https://raw.githubusercontent.com/equantum-py/joyerialis/main/public/assets/img/logo/jolie-logo-desktop.svg';
const MOBILE_LOGO_SRC = 'https://raw.githubusercontent.com/equantum-py/joyerialis/main/public/assets/img/logo/jolie-logo-mobile.svg';
  ...
  return (
    <>
      <style>{`
        ...
        .jolie-header-inner{height:128px;display:grid;grid-template-columns:340px 1fr 220px;align-items:center;gap:20px;position:relative}
        .jolie-logo-link{display:inline-flex;align-items:center;text-decoration:none}
        .jolie-desktop-logo .jolie-logo-link{justify-content:flex-start}
        .jolie-desktop-logo-img{display:block;width:250px;height:112px;object-fit:contain;object-position:left center}
        ...
        @media(max-width:1199px){
          .jolie-header-inner{height:84px;display:flex;align-items:center;justify-content:space-between;position:relative;padding-left:14px;padding-right:14px}
          ...
          .jolie-mobile-logo-img{display:block;width:156px;height:64px;object-fit:contain;object-position:center}
        ...
        @media(max-width:767px){
          ...
          .jolie-header-inner{height:76px;padding-left:12px;padding-right:12px}.jolie-actions{gap:14px}.jolie-actions .hide-xs{display:none}
          .jolie-mobile-logo{left:50%;top:50%;transform:translate(-50%,-50%)}
          .jolie-mobile-logo-img{width:148px;height:60px}
        }
      `}</style>
      ...
      <header className="jolie-header"><div className="container jolie-header-inner">
        <div className="jolie-desktop-logo"><Link href="/" className="jolie-logo-link"><img src={DESKTOP_LOGO_SRC} alt="Jolie Jewelry" className="jolie-desktop-logo-img"/></Link></div>
        ...
        <div className="jolie-mobile-logo"><Link href="/" className="jolie-logo-link"><img src={MOBILE_LOGO_SRC} alt="Jolie Jewelry" className="jolie-mobile-logo-img"/></Link></div>
