  ...
  return (
    <div className="tp-cart-checkout-wrapper">
      <div className="tp-cart-checkout-top d-flex align-items-center justify-content-between">
        ...
        <span className="tp-cart-checkout-top-price">{formatGs(total)}</span>
      </div>
        ...
        <div className="tp-cart-checkout-shipping-option-wrapper">
          <div className="tp-cart-checkout-shipping-option">
            ...
            <label htmlFor="flat_rate" onClick={()=> handleShippingCost(20)}>
              Flat rate: <span>{formatGs(20)}</span>
            </label>
          </div>
          <div className="tp-cart-checkout-shipping-option">
            <input id="local_pickup" type="radio" name="shipping" />
            <label htmlFor="local_pickup" onClick={()=> handleShippingCost(25)}>
              Local pickup: <span>{formatGs(25)}</span>
            </label>
          </div>
          <div className="tp-cart-checkout-shipping-option">
      ...
      <div className="tp-cart-checkout-total d-flex align-items-center justify-content-between">
        <span>Total</span>
        <span>{formatGs(total + shipCost)}</span>
      </div>
