  ...
  return (
    <>
      <style>{`
        ...
        .jolie-header-inner{height:106px;display:grid;grid-template-columns:220px 1fr 220px;align-items:center;gap:24px}
        .jolie-logo-link{display:inline-flex;align-items:center;justify-content:flex-start;text-decoration:none}
        .jolie-logo-img{display:block;width:118px;height:82px;object-fit:contain;object-position:center}
        ...
        @media(max-width:1199px){.jolie-header-inner{height:84px;grid-template-columns:1fr auto 1fr}.jolie-nav,.jolie-desktop-logo{display:none}.jolie-mobile-logo{display:flex;justify-content:center}.jolie-mobile-logo .jolie-logo-img{width:82px;height:66px}.jolie-actions{grid-column:3}.jolie-menu-btn{display:inline-flex}}
      ...
      <header className="jolie-header"><div className="container jolie-header-inner">
        <div className="jolie-desktop-logo"><Link href="/" className="jolie-logo-link"><img src={LOGO_SRC} alt="Jolie Jewelry - Bonita y única" className="jolie-logo-img"/></Link></div>
        ...
        <div className="jolie-mobile-logo"><Link href="/" className="jolie-logo-link"><img src={LOGO_SRC} alt="Jolie Jewelry - Bonita y única" className="jolie-logo-img"/></Link></div>
