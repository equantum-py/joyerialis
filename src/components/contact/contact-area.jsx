            ...
            <div className="row">
              <div className="col-xl-9 col-lg-8">
                <div className="tp-contact-wrapper">
                  <h3 className="tp-contact-title">Envíanos un mensaje</h3>
                ...
                <div className="tp-contact-info-wrapper">
                  <div className="tp-contact-info-item">
                    ...
                    <div className="tp-contact-info-content">
                      <p data-info="mail">
                        <a href="mailto:contacto@joyerialis.com">contacto@joyerialis.com</a>
                      </p>
                      <p data-info="phone">
                        <a href="tel:+595210000000">+595 21 000 000</a>
                      </p>
                    </div>
                  </div>
                  <div className="tp-contact-info-item">
